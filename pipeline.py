...
LUA_SHA1 = get_hash(os.path.join(CWD, 'vine.lua'))
...
class WgetArgs(object):
    def realize(self, item):
        wget_args = [
            ...
            "--warc-header", "vine-dld-script-version: " + VERSION,
            "--warc-header", ItemInterpolation("vine-item: %(item_name)s"),
        ]
        ...
        def add_video(video_id):
            ...
            wget_args.append('https://vine.co/v/{video_id}/embed/simple?api=1'.format(**locals()))
            wget_args.append('https://vine.co/v/{video_id}/embed/simple?api=0'.format(**locals()))
            ...
            wget_args.append('https://vine.co/v/{video_id}/embed/wide?api=1'.format(**locals()))
            wget_args.append('https://vine.co/v/{video_id}/embed/wide?api=0'.format(**locals()))
            ...
            wget_args.append('https://vine.co/v/{video_id}/embed/postcard?api=1'.format(**locals()))
            wget_args.append('https://vine.co/v/{video_id}/embed/postcard?api=0'.format(**locals()))
            ...
            wget_args.append('https://vine.co/v/{video_id}/fb-card?api=1'.format(**locals()))
            wget_args.append('https://vine.co/v/{video_id}/fb-card?api=0'.format(**locals()))
            ...
            wget_args.append('https://vine.co/v/{video_id}/card?api=0'.format(**locals()))
            ...
            wget_args.append('https://vine.co/v/{video_id}?video=0'.format(**locals()))
            wget_args.append('https://vine.co/v/{video_id}?video=1'.format(**locals()))

        if item_type == 'video':
            add_video(item_value)
...
project = Project(
    title="vine",
    project_html="""
        <img class="project-logo" alt="Project logo" src="http://archiveteam.org/images/0/0d/Vine_Logo.png" height="50px" title=""/>
        <h2>vine.co <span class="links"><a href="http://vine.co/">Website</a> &middot; <a href="http://tracker.archiveteam.org/vine/">Leaderboard</a></span></h2>
        <p>Archiving videos from vine.co.</p>
    """
)
...
pipeline = Pipeline(
    ...
    GetItemFromTracker("http://%s/%s" % (TRACKER_HOST, TRACKER_ID), downloader,
        VERSION),
    PrepareDirectories(warc_prefix="vine"),
    WgetDownload(
        WgetArgs(),
        max_tries=2,
